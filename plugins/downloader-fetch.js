...
return conn.reply(m.chat, `${error_emoji} *Too many redirections*\n_(máx: ${maxRedirects})_`, m, fake, )
}
...
if (!text) {
return conn.reply(m.chat, `🎌 *Enter a page link*\n\nExample, !get https://github.com`, m, fakes, )
}
...
if (redirectCount >= maxRedirects) {
return conn.reply(m.chat, `${error_emoji} *Too many redirects*\n_(max: ${maxRedirects})_`, m, fake, )
}
